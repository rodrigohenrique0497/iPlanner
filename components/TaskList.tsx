      ...
      <div className="space-y-4">
        ...
        {filteredTasks.length === 0 && (
          <div className="py-24 text-center space-y-4 opacity-40">
            ...
            <button onClick={() => { setFilterCategory('all'); setFilterPriority('all'); setSearchQuery(''); }} className="text-[10px] font-black text-theme-accent uppercase underline tracking-widest active:scale-95">Limpar Filtros</button>
          </div>
        )}
      </div>
    </div>
