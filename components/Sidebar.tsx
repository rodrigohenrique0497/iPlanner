    ...
    <>
      ...
      `}>
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3 px-5 py-3.5 rounded-planner-sm transition-all duration-300 group relative ${
                  isActive
                    ...
                    : 'text-theme-text opacity-70 hover:opacity-100 hover:bg-theme-accent-soft hover:text-theme-text'
                }`}
              >
        ...
        <div className="p-5 border-t border-theme-border shrink-0 bg-theme-bg">
          <div className="bg-theme-card rounded-planner-sm p-5 border border-theme-border shadow-sm mb-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[8px] font-black uppercase tracking-widest text-theme-text opacity-50">Nível {user.level}</p>
          ...
          >
            <span className="material-symbols-outlined !text-lg">power_settings_new</span> Sair
          </button>
        </div>
      </aside>
    </>
